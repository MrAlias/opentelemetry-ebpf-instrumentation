...
- [Configuration Reference](config/CONFIG.md): generated YAML and environment variable reference.
...
- [Exclude OTel-Instrumented Services](exclude-otel-instrumented-services.md): detection and suppression rules for services already exporting OTLP.
...
- [Trace-Log Correlation](trace-log-correlation.md): standard communication channel for correlating logs to OBI traces.
