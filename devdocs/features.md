...
| GenAI         |    All    |         All | All                                                                                      |  Yes   |                 No |                           Supported vendors and protocols: OpenAI, Anthropic, Google AI Studio (Gemini), AWS Bedrock, Qwen (DashScope), generic embedding providers (Voyage AI, Cohere, Jina AI), Model Context Protocol (MCP), and rerank APIs from Cohere, Jina AI, Voyage AI, and Qwen (DashScope)
