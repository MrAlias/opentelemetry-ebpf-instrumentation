...
| #28 Java extraction matrix | applicable getsockopt and Unix application cases passed with exact graphs and one-shot counter assertions; `OfficialAgentJettyRuntimeTest` covers registered re-extraction, nested Jetty/Servlet advice, precedence, async dispatch, keepalive, and parallel connections, while the companion Netty and Java 21 probes cover inbound and executor/virtual-thread handoff with pinned, checksum-verified stock OpenTelemetry and Splunk agents | none; [Java Agent CI run 105](https://github.com/MrAlias/opentelemetry-ebpf-instrumentation/actions/runs/31675830100) passed across Java 8, 11, 17, and 21, and agent/environment matrix expansion remains tracked by #27 and #38 rather than reopening #28 |
...
| #35 handoff | retained application graphs cover blocking, executor, virtual-thread, Netty worker, redispatch, and inbound-Netty paths; stock-agent Jetty tests exercise exact parents plus depth-64, ancestor-cycle, late-framework, and transport-missing outcomes, while Netty, packaged executor, and Java 21 controls enforce relay cleanup, unwind/recovery, concurrency, migration, and carrier/worker reuse | none; [Java Agent CI run 105](https://github.com/MrAlias/opentelemetry-ebpf-instrumentation/actions/runs/31675830100) passed across Java 8, 11, 17, and 21, and broader framework/environment expansion remains tracked by #38 |
