...
`otel-getsockopt-tls13-c9d14356` and `otel-unix-tls12-bd1c9327` bundles use
`operation="availability"` and retain V2 Java transport-configuration
snapshots. The prior `otel-getsockopt-tls13-94221a91` bundle uses the same
current schema. The current schema has an
