...
cgroup paths, BPF map and program identifiers, and the pressure helper's
per-run cleanup inputs. It also omits built JARs and filename-oriented
checksum lists; their content hashes remain in bridge-artifacts.json.
