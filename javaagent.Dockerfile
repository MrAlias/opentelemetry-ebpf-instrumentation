...
FROM gradle:9.7.0-jdk21-noble@sha256:7818865626870c3bfd7847482bce8462e1e436a02e0b1c7737c0c47a06a1a6de AS builder
...
COPY --from=builder /workspace/pkg/internal/java/build/obi-java-agent.jar /obi-java-agent.jar
COPY --from=builder /workspace/pkg/internal/java/build/obi-otel-extension.jar /obi-otel-extension.jar
