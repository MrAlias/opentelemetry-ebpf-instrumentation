...
func (f fakeRuntimeServiceFilter) AllowPID(
	app.PID, uint32, *exec.FileInfo, *exec.FileInfo, PIDType, ...PIDAdmissionCommit,
) bool {
	return true
}
func (f fakeRuntimeServiceFilter) BlockPID(app.PID, uint32, *exec.FileInfo, *exec.FileInfo) {}
