      ...
      Collections.unmodifiableSet(
          new LinkedHashSet<>(
              Arrays.asList(
                  ...
                  "io.opentelemetry.obi.java.instrumentations.data.RemoteParentHttp1Framer$Action",
                  "io.opentelemetry.obi.java.instrumentations.data.RemoteParentHttp1Framer$ReceivePlan",
                  "io.opentelemetry.obi.java.instrumentations.data.RemoteParentHttp1Framer$State",
                  "io.opentelemetry.obi.java.instrumentations.data.RemoteParentHttp1Framer$BodyKind",
